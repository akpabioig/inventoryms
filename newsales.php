...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#discountcust").change(function(){
            ...
            $("#tot").val(document.getElementById('minitotal').value);
            $("#subtotal").val(parseInt(parseInt(document.getElementById('costcust').value) * parseInt(document.getElementById('quancust').value)) - (parseInt(document.getElementById(this.value))));
