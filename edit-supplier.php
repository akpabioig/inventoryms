            ...
            <div  id = "form2">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="add1" name="add1" class="formfield" rows=1
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="town" name="town" class="formfield" rows=1
                    ...
                    <tr>
                        <td label for="postc"> Postcode/ Zipcode :</td>
                        ...
                        <td><input type="text" id="country" name="country" class="formfield" rows=1
