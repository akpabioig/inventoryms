    ...
    <section id = "content">
        <div id = "log">
            ...
            <table>
                ...
                <tr>
                    <td><input type="text" id="usn" name="user" value="" class = "formfiel" rows = 1 cols = 40></td>
                </tr>
                <tr>
                    <td label for="pass"> <a id = "hash">*</a> Password : </td>
                </tr>
                <tr>
                    <td><input type="password" id="pass" name="pass" value="" class = "formfiel" rows = 1 cols = 40></td>
                </tr>
            </table>
