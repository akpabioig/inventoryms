...
<div style="margin-left:70px">
    ...
    <section>
        ...
        <form method="post" action="allproducts.php"">
                    ...
                    if(mysqli_num_rows($result) == 1 || mysqli_num_rows($result) >1){
                        ...
                        while($row = $result -> fetch_array()){
                            echo "
                                ...
                                <tr>
                        <td class='shrink'><input type=\"text\" id = \"productid\" name= \"productid\"  value = \"{$row['productid']}\" class = \"tablefield\" disabled></td>
           ...
           99             <td><input type=\"text\" id = \"productdesc\" name= \"productdesc\"  value = \"{$row['productdescription']}\" class = \"tablefield\" disabled></td>
