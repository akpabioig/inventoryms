            ...
            <div id = "form3">
                <table id="t2">
                    ...
                    if(mysqli_num_rows($result) == 1 || mysqli_num_rows($result) >1){
                        ...
                        <td><a href='edit-product.php?prodid={$row['productid']}'><img src = 'images/edit.png' style{height=\"12\" width=\"25\"}></a></td>
                        <td><a href='deleteproduct.php?prodid={$row['productid']}'> <img src = 'images/delete.png' style{height=\"12\" width=\"25\"}></a> </td>
                    </tr>
