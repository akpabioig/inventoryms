        ...
        <div id = "log">
            ...
            <form method="POST" action="usercreation.php">
                <table>
                    ...
                    <tr>
                        <td label for = middlename> LAST NAME : </td>
                    </tr>
                    <tr>
                        <td> <input type="text" id="middlename" name="middlename" value="" class = "formfiel" rows = 1 cols = 40></td>
                    </tr>
                    <tr>
                        <td label for = position> POSITION : </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><input type="text" id="myusername" name="myusername" value="" class = "formfiel" rows = 1 cols = 40></td>
                    </tr>
                    <tr>
                        <td label for="pass"> <a id = "hash">*</a> Password : </td>
                    </tr>
                    <tr>
                        <td><input type="password" id="mypassword" name="mypassword" value="" class = "formfiel" rows = 1 cols = 40></td>
                    </tr>
                </table>
