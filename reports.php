        ...
        <div id = "form1">
            <div class="locbutt">
                <a href="allcustomers.php">
                    <img src="report/c_report.jpg" style{height="80" width="100" } class="reporticons"/>
                </a>
                <a href="allsuppliers.php">
                    <img src="report/s_report.jpg" style{height="80" width="100" } class="reporticons"/>
                </a>
                <a href="allproducts.php">
                    <img src="report/p_report.jpg" style{height="80" width="100" } class="reporticons"/>
                </a>
            ...
            <div class="locbutt2">
                ...
                <a href="allsales.php">
                    <img src="report/so_report.jpg" style{height="80" width="100" } class="reporticons"/>
                </a>
                <a href="stocklevel.php">
                    <img src="report/sl_report.jpg" style{height="80" width="100" } class="reporticons"/>
                </a>
            </div>
        </div>
    </section>
